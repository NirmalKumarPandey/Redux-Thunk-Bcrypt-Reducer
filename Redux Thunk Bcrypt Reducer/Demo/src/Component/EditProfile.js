...
function EditProfile() {
    ...
    useEffect(() => {
        firstInputRef.current.value = storeObj.reducer.userDetails.firstName;
        lastInputRef.current.value = storeObj.reducer.userDetails.lastName;
        ageInputRef.current.value = storeObj.reducer.userDetails.age;
        emailInputRef.current.value = storeObj.reducer.userDetails.email;
        mobileInputRef.current.value = storeObj.reducer.userDetails.mobile;
        setProfilePic(`http://localhost:4567/${storeObj.reducer.userDetails.profilePic}`)
    }, [storeObj.reducer.userDetails.firstName, storeObj.reducer.userDetails.lastName, storeObj.reducer.userDetails.age, storeObj.reducer.userDetails.email, storeObj.reducer.userDetails.mobile, storeObj.reducer.userDetails.profilePic]);
